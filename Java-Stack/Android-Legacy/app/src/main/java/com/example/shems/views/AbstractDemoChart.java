...
public  class AbstractDemoChart implements IDemoChart {
   ...
   *
   * @param titles the series titless
  ...
  public CategorySeries buildCategoryDataset(String title,String legend[], double[] values) {
	    CategorySeries series = new CategorySeries(title);
	    int k = 0;
	    for (double value : values) {
	      series.add(legend[k], value);
	      k++;
	    }
