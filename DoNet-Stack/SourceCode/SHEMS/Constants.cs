...
namespace SHEMS
{
    class Constants
    {
        public static  string LOAD_ANALYSIS_SERVER_ADDR = "http://10.0.0.13:800/WebFormLoadService.aspx";
        public static string SENSOR_DATA_SERVER_ADDR = "http://10.0.0.13:800/WebFormLoadService.aspx?sensorData=true";
        ...
        public static  string METER_SERVER_IP = "10.0.0.106";
